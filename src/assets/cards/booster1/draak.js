...
module.exports = {
  ...
  altImg: require('../../img/creatures/alternative/draak-alternative.png'),
  color: 'pure',
  hp: 9,
  abilities: [
    {
  ...
  unlockTable: [
    ...
    },
    {
      level: 8,
      type: 'skill',
      id: 'draak_skill_golpe_ancestral',
      name: { pt: 'Golpe Ancestral', en: 'Ancestral Strike' },
      desc: {
        pt: 'Causa 2 de dano; graças ao olhar crescente de Draak, esse dano aumenta permanentemente em +1 a cada ataque.',
        en: "Deals 2 damage; thanks to Draak's growing gaze, this damage permanently increases by +1 with each attack.",
      },
      cost: 1,
      damage: 2,
    },
