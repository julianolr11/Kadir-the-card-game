...
module.exports = {
  ...
  story: [
    {
      pt: 'Ekeranth nasceu nas entranhas ardentes de Ashkarn, forjado quando um ritual para controlar o fogo primordial saiu do controle e fez um vulcão inteiro ruir sobre si mesmo. Do colapso surgiu um draconídeo de pele vermelha incandescente, com veias de magma pulsando sob a carne como um coração em fúria.',
      en: 'Ekeranth was born in the burning bowels of Ashkarn, forged when a ritual to control primordial fire spiraled out of control and brought an entire volcano crashing down. From the collapse emerged a draconid with incandescent red skin, magma veins pulsing beneath flesh like a heart in fury.',
    },
    {
      pt: 'Seu corpo exala fumaça constante, e cada movimento faz a terra rachar. Torres de pedra derretem sob suas garras, e suas asas, cortadas por fissuras luminosas, espalham brasas por onde passam.',
      en: 'His body exhales constant smoke, and each movement cracks the earth. Stone towers melt under his claws, and his wings, cut by luminous fissures, spread embers wherever they pass.',
    },
    {
      pt: 'Nos olhos verdes arde uma consciência antiga: fragmentos das mentes que tentaram criá-lo. Por isso, Ekeranth não caça por instinto — ele caça por julgamento.',
      en: 'In his green eyes burns an ancient consciousness: fragments of the minds that tried to create him. This is why Ekeranth does not hunt by instinct — he hunts by judgment.',
    },
    {
      pt: 'Ele não reina sobre reinos. Ele os reduz a cinzas.',
      en: 'He does not reign over kingdoms. He reduces them to ashes.',
    },
  ],
