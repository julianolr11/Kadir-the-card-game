...
module.exports = {
  ...
  abilities: [
    {
      ...
      cost: 1,
      desc: {
        pt: 'Causa 2 de dano e reduz precisão do inimigo em 1 por 1 turno.',
        en: 'Deals 2 damage and applies imprecision for 1 turn.',
      },
    },
    {
      ...
      cost: 1,
      desc: {
        pt: 'Fica furtiva e ganha +1 esquiva até o próximo turno.',
        en: 'Becomes stealthy and gains +1 evasion until next turn.',
      },
    },
  ],
  ...
  defaultSkills: [
    ...
    },
    {
      ...
      desc: {
        pt: 'Causa 2 de dano a todos os inimigos e reduz precisão em 1 por 1 turno.',
        en: 'Deals 2 damage to all enemies and reduces accuracy by 1 for 1 turn.',
      },
      cost: 1,
      type: 'damage_debuff',
    },
  ...
  unlockTable: [
    { level: 0, type: 'none' },
    {
      ...
      desc: {
        pt: 'Causa 3 de dano e paralisa jogue a moeda 1 vez; se der cara por 1 turno.',
        en: 'Deals 3 damage and flips a coin once; on heads, paralyzes for 1 turn.',
      },
      cost: 1,
    },
    { level: 2, type: 'perk', id: 'HP_PLUS_1' },
    {
      ...
      desc: {
        pt: 'Fica furtiva, ganha +1 esquiva e reduz o dano recebido em 1 por 2 turnos.',
        en: 'Becomes stealthy, gains +1 evasion and reduces damage taken by 1 for 2 turns.',
      },
      cost: 2,
    },
    { level: 4, type: 'perk', id: 'DODGE_INCREASE' },
    {
      ...
      desc: {
        pt: 'Causa 3 de dano em área, fica furtiva e +1 esquiva por 2 turnos.',
        en: 'Deals 3 area damage, becomes stealthy and +1 evasion for 2 turns.',
      },
      cost: 2,
    },
    ...
    },
    {
      ...
      desc: {
        pt: 'Supremo: Causa 4 de dano, paralisa garantido 1 turno e reduz defesa em 1 por 2 turnos.',
        en: 'Ultimate: Deals 4 damage, guaranteed 1-turn paralysis and reduces defense by 1 for 2 turns.',
      },
      cost: 3,
    },
  ],
