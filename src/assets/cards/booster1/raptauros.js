...
module.exports = {
  ...
  defaultBlessing: {
    ...
    desc: {
      pt: 'Aliados de terra ganham +1 dano se a moeda der cara.',
      en: 'Earth allies gain +1 damage on heads.',
    },
  },
  unlockTable: [
    { level: 0, type: 'none' },
    ...
    // Nível 3 - Habilidade: Chifre Trovejante
    {
      ...
      desc: {
        pt: 'Causa 3 de dano e jogue a moeda 1 vez; se der cara, atordoa por 1 turno.',
        en: 'Deals 3 damage and flips a coin once; on heads, stuns for 1 turn.',
      },
      cost: 1,
    ...
    // Nível 9 - Habilidade: Tempestade de Areia
    {
      ...
      cost: 3,
      effectType: 'aoe_damage_accuracy_down',
      damage: 2,
    ...
    // Nível 10 - Habilidade: Domínio das Dunas
    {
      ...
      cost: 3,
      effectType: 'damage_team_defense_buff',
      damage: 4,
